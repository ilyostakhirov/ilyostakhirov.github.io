(function(global, factory) {
    ...
    (function() {
        var tableContent = (0, _jquery2.default)('#examplePopoverTable').html(),
            tableSettings = {
                title: 'Запрос на подключение статуса ПРОВЕРЕННАЯ КОМПАНИЯ',
    ...
    (function() {
        var tableContent = (0, _jquery2.default)('#examplePopoverTable1').html(),
            tableSettings = {
    ...
    (function() {
        ...
        (0, _jquery2.default)('#examplePopWithTable2').webuiPopover(_jquery2.default.extend({}, defaults, tableSettings));
    })();
